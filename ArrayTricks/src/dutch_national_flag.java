...
public class dutch_national_flag {
    ...
    void solve() {
        Arrays.stream(segregateNumbers(new int[]{0, 1, 2, 0, 2, 1, 1})).forEach(i -> System.out.print(i + " "));
    }

    private int[] segregateNumbers(int[] input) {
        int low = 0;
