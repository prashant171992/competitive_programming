...
public class array_even_odd_at_one_place {
    InputStream is;
    ...
    // reorder input array so that even entries appear first then odd one appears.
    void solve() {
        Arrays.stream(rearrangeArray(new int[]{2, 3, 4, 6, 9, 8})).forEach(i -> System.out.print(i + " "));
    }
    ...
    int[] rearrangeArray(int[] input) {
        ...
        while (evenIndex > oddIndex) {
            if (input[evenIndex] % 2 == 0 && input[oddIndex] % 2 == 1) {
    ...
    public static void main(String[] args) throws Exception {
        new array_even_odd_at_one_place().run();
    }
