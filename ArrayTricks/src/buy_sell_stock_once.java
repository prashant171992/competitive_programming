...
public class buy_sell_stock_once {
    ...
    void solve() {
        out.println(maxProfit(Arrays.asList(310, 315, 275, 295, 260, 270, 290, 230, 255, 250)));
    }

    private int maxProfit(List<Integer> array) {
        int min = array.get(0);
        int profit = 0;
        for (int i = 1; i < array.size(); ++i) {
            min = Math.min(min, array.get(i));
            profit = Math.max(profit, array.get(i) - min);
        }
