...
public class k_element_spiral_array {
    InputStream is;
    ...
    // Problem statement : Compute the kth element in spiral order for an mxn 2D array A in O(1) time.
    ...
    public static void main(String[] args) throws Exception {
        new k_element_spiral_array().run();
    }
