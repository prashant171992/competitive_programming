...
public class find_bridge {
    ...
    /* Ref : https://www.geeksforgeeks.org/check-removing-given-edge-disconnects-given-graph/
            & Page 375 */
    ...
    class Graph {
        ...
        void removeEdge(int v1, int v2) {
            this.adj[v1].removeFirstOccurrence(v2);
            this.adj[v2].removeFirstOccurrence(v1);
        }

        void dfs(int vertex) {
            visited[vertex] = true;
            for (int i = 0; i < this.adj[vertex].size(); ++i) {
                int neighbour = this.adj[vertex].get(i);
    ...
    void solve() {
        ...
        out.println("Edge removed is a bridge ? : " + graph.isBridge());
    }
