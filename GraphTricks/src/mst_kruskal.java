...
public class mst_kruskal {
        ...
        int minCost(Graph graph) {
            ...
            for (int i = 0; i < edgeList.size(); ++i) {
                ...
                if (sourceRoot != destRoot) {
                    ...
                    cost += edge.cost;
                    out.println(edge.src + " " + edge.dest + " " + edge.cost);
                }
            }
            return cost;
        }
    ...
    void solve() {
        ...
        graph.edgeList.add(graph.new Edge(0, 1, 1));
        graph.edgeList.add(graph.new Edge(0, 2, 2));
        graph.edgeList.add(graph.new Edge(0, 3, 3));
        graph.edgeList.add(graph.new Edge(0, 4, 4));
        graph.edgeList.add(graph.new Edge(1, 0, 1));
        graph.edgeList.add(graph.new Edge(1, 2, 5));
        graph.edgeList.add(graph.new Edge(1, 4, 7));
        graph.edgeList.add(graph.new Edge(2, 0, 2));
        graph.edgeList.add(graph.new Edge(2, 1, 5));
        graph.edgeList.add(graph.new Edge(2, 3, 6));
        graph.edgeList.add(graph.new Edge(3, 0, 3));
        graph.edgeList.add(graph.new Edge(3, 2, 6));
        graph.edgeList.add(graph.new Edge(4, 0, 4));
        graph.edgeList.add(graph.new Edge(4, 1, 7));

        out.println(graph.minCost(graph));
