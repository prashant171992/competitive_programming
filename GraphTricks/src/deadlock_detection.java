...
public class deadlock_detection {
    ...
    boolean isDeadLocked(List<GraphVertex> G) {
        for (GraphVertex graphVertex : G) {
            if (graphVertex.color.equals(GraphVertex.Color.WHITE) && hasCycle(graphVertex)) {
                return true;
            }
        }
        return false;
    ...
    private boolean hasCycle(GraphVertex graphVertex) {
        if (graphVertex.color.equals(GraphVertex.Color.GRAY)){
            return true;
        }
        graphVertex.color = GraphVertex.Color.GRAY;
        for (GraphVertex neighbour : graphVertex.graphVertices) {
            if (!neighbour.color.equals(GraphVertex.Color.BLACK)) {
