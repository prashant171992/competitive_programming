...
public class online_stock_span {
    ...
    void solve() {
        ...
        out.println(obj.next(100));
        out.println(obj.next(80));
        out.println(obj.next(60));
        out.println(obj.next(70));
        out.println(obj.next(60));
        out.println(obj.next(75));
        out.println(obj.next(85));
    }
    ...
    class StockSpanner {
        ...
        public int next(int price) {
            array.add(price);
            while (!stack.isEmpty() && array.get(stack.peek()-1) <= price) {
                stack.pop();
            }
            int ans = stack.isEmpty() ? array.size() : array.size() - stack.peek();
