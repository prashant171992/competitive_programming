...
public class best_time_to_buy_and_sell_stock_with_cooldown {
    ...
    void solve() {
        out.println(maxProfit(new int[]{1,2,3,0,2}));
    }
...
//            return 0;
//        }
//        int[] oldState = new int[]{0, -prices[0], 0};
//        int[] newState = new int[3];
//        for (int i = 1; i<prices.length; ++i){
//            newState[0] = Math.max(oldState[0], oldState[2]);
//            newState[1] = Math.max(oldState[1], oldState[0] - prices[i]);
//            newState[2] = oldState[2] + prices[i];
//            oldState = newState;
//        }
//        return Math.max(newState[0], newState[2]);
    ...
    public static void main(String[] args) throws Exception {
        new best_time_to_buy_and_sell_stock_with_cooldown().run();
    }
