...
public class multiply_with_shift_operator {
    InputStream is;
    ...
    long getSum(long a, long b) {
        ...
        while (tempA != 0 || tempB != 0) {
            long first = a&k;
            long second = b&k;
            carryOut = (first | carryIn) & (second | carryIn) & (first & second);
            sum |= (first ^ second ^ carryIn);
            carryIn = carryOut << 1;
            tempA >>>= 1;
            tempB >>>= 1;
            k <<=1;
    ...
    public static void main(String[] args) throws Exception {
        new multiply_with_shift_operator().run();
    }
