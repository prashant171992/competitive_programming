...
public class next_Higher_Number_With_same_set_bit {
    InputStream is;
    ...
    void solve() {
        ...
        for (int i = 0; i <= (1 << Integer.BYTES) - 1; ++i) {
            int f = (num >>> (i+1)) & 1;
            int s = (num >>> i) & 1;
            if (f == 0 && f != s) {
                num ^= ((1L << i) | (1L << (i+1)));
        ...
        out.println("No next higher with same set bits found !");
    ...
    public static void main(String[] args) throws Exception {
        new next_Higher_Number_With_same_set_bit().run();
    }
